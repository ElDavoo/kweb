/*                    Minimal Kiosk Browser 
   ...
   Version 1.7.8 using gtk+3 and webkitgtk-3.0
*/
...
static gchar* fs_u = "u";
static gchar* fs_f = "f";
static gchar* default_ua = "Mozilla/5.0 (X11; Linux armv6l) AppleWebKit/538.15 (KHTML, like Gecko) Version/8.0 Safari/538.15 kweb3/1.7.8";
...
/*        g_object_set(G_OBJECT(settings), "enable-site-specific-quirks", TRUE,NULL); */
	...
	gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Open file   Alt o");
	...
	gtk_toolbar_insert(GTK_TOOLBAR( toolbar ), item, -1);
	gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Back to last page   Alt b");
	...
	gtk_toolbar_insert(GTK_TOOLBAR(toolbar), item, -1);
	gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Stop loading   Alt s");
	...
	gtk_toolbar_insert(GTK_TOOLBAR(toolbar), item, -1);
	gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Reload page   Alt r");
	...
	gtk_toolbar_insert(GTK_TOOLBAR(toolbar), item, -1);
	gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Open your homepage   Alt h");
	...
	gtk_toolbar_insert(GTK_TOOLBAR(toolbar), item, -1);
        gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Play video from website   Alt p");
	...
	gtk_tool_button_set_icon_name (GTK_TOOL_BUTTON( item ),"zoom-in");
        gtk_toolbar_insert(GTK_TOOLBAR(toolbar), item, -1);
        gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Zoom in by 10%   Alt +");
	...
	gtk_tool_button_set_icon_name (GTK_TOOL_BUTTON( item ),"zoom-out");
        gtk_toolbar_insert(GTK_TOOLBAR(toolbar), item, -1);
	gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Zoom out by 10%   Alt -");
	...
	gtk_tool_button_set_icon_name (GTK_TOOL_BUTTON( item ),"zoom-original");
        gtk_toolbar_insert(GTK_TOOLBAR(toolbar), item, -1);
        gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Reset zoom to 100%   Alt z");
	...
	gtk_tool_button_set_label (GTK_TOOL_BUTTON( item ),"Full Zoom");
        ...
        gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Global, full zoom or text zoom only   Alt g,t");
	...
	gtk_tool_button_set_label (GTK_TOOL_BUTTON( item ),"Javascript");
        ...
        gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Javascript or No Javascript   Alt j,n");
	...
	gtk_tool_button_set_label (GTK_TOOL_BUTTON( item ),"Plugins");
        ...
        gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Enable/Disable Plugins");
	...
	gtk_tool_button_set_label (GTK_TOOL_BUTTON( item ),"Cookies");
        ...
        gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Enable/disable cookies   Alt e,d");
	...
	gtk_tool_button_set_label (GTK_TOOL_BUTTON( item ),"DL-Manager");
        ...
        gtk_widget_set_tooltip_text(GTK_WIDGET(item),"uGet or wget for downloads   Alt u,w");
	...
	gtk_tool_button_set_label (GTK_TOOL_BUTTON( item ),"Omxplayer");
        ...
        gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Use omXplayer for media   Alt x,y");
	...
	gtk_tool_button_set_label (GTK_TOOL_BUTTON( item ),"Commands");
        ...
        gtk_widget_set_tooltip_text(GTK_WIDGET(item)," Activate/veto command execution   Alt a,v");
